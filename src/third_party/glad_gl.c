...
PXGLADBUFFERSUBDATAPROC glad_glBufferSubData = NULL;
PXGLADBLENDFUNCSEPARATEPROC glad_glBlendFuncSeparate = NULL;
...
PXGLADLINEWIDTHPROC glad_glLineWidth = NULL;
PFNGLLINKPROGRAMPROC glad_glLinkProgram = NULL;
PXGLADPOLYGONMODEPROC glad_glPolygonMode = NULL;
...
int gladLoadGL(GLADloadfunc load) {
    ...
    LOAD_GL_WITH(load, glBufferSubData, PXGLADBUFFERSUBDATAPROC);
    LOAD_GL_WITH(load, glBlendFuncSeparate, PXGLADBLENDFUNCSEPARATEPROC);
    ...
    LOAD_GL_WITH(load, glLineWidth, PXGLADLINEWIDTHPROC);
    LOAD_GL_WITH(load, glLinkProgram, PFNGLLINKPROGRAMPROC);
    LOAD_GL_WITH(load, glPolygonMode, PXGLADPOLYGONMODEPROC);
