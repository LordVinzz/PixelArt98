...
Legend: `✓` strong/native support, `~` partial or workflow-dependent support, `✗` not a primary feature.

| Capability | PixelArt98 | Photoshop | Lightroom | Aseprite |
| --- | --- | --- | --- | --- |
| Free non-commercial use | ✓ | ✗ | ✗ | ✗ |
| Source-available code | ✓ | ✗ | ✗ | ✓ |
| Native Windows/macOS/Linux app | ✓ | ~ | ~ | ✓ |
| Pixel-art focused drawing | ✓ | ~ | ✗ | ✓ |
| Pixel-perfect/freehand workflow | ~ | ✗ | ✗ | ✓ |
| Layers | ✓ | ✓ | ✗ | ✓ |
| Blend modes | ✓ | ✓ | ✗ | ✓ |
| Layer masks | ✓ | ✓ | ~ | ✓ |
...
| Spritesheet export | ✓ | ~ | ✗ | ✓ |
| Tilemap editing | ✗ | ✗ | ✗ | ✓ |
| Minecraft-style cuboid texture workflow | ✓ | ✗ | ✗ | ✗ |
| 3D textured model preview | ✓ | ✓ | ✗ | ✗ |
| RAW photo catalog/library workflow | ✗ | ✗ | ✓ | ✗ |
| Professional photo retouching depth | ✗ | ✓ | ✓ | ✗ |
| Scripting/plugin ecosystem | ✗ | ✓ | ✓ | ✓ |
